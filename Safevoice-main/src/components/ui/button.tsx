  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-emergency transition-smooth",
        outline:
        ...
        emergency: "bg-gradient-emergency text-destructive-foreground hover:opacity-90 shadow-emergency transition-bounce",
        hero: "bg-gradient-hero text-primary-foreground hover:opacity-90 shadow-glow transition-bounce",
        safe: "bg-gradient-safe text-success-foreground hover:opacity-90 transition-smooth",
