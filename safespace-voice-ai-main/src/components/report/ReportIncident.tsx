...
export const ReportIncident = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="space-y-2 px-4 md:px-8 mt-4 mb-4">
        ...
        {showNewReportForm && (
          <Card>
            ...
            <CardContent className="space-y-6">
              {/* Safety Quick Actions - hide if loadedDraftId is set */}
              {!loadedDraftId && (
                <div className="flex gap-3 mb-4">
                  ...
                  <Button variant="outline" className="flex-1" onClick={saveAsDraft}>
                    <Save className="h-4 w-4 mr-2" /> Quick Save
                  </Button>
                  <Button variant="ghost" className="flex-1" onClick={() => window.location.href = '/'}>
                    <X className="h-4 w-4 mr-2" /> Safe Exit
                  </Button>
                </div>
              )}
